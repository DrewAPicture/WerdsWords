---
title: A frustrating journey to Joomla and back
date: '2011-04-23'
tags:
  - cms
  - joomla
...
Turns out they use [Joomla](http://www.joomla.org), and while I dabbled with it some in the days before 1.0, I'd never really found it that intuitive. Unfortunately, not much has changed.

My first instinct upon login was to figure out how the structure worked. I guess it is only natural that with CMS systems like these that there's and inherent lingo that goes along with them. With [WordPress](http://www.wordpress.org), I'm used to lingo like widgets, posts and pages. In Joomla, I'm dealing with articles (posts), components (?), modules (widgets?) and plugins.
